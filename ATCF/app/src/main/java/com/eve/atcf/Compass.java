...
public class Compass implements SensorEventListener {
    ...
    public Compass(Context context, MainActivity m) {
        mainActivity = m;
...
//    //TODO UPDATE WITH NEW FUNCTION https://stackoverflow.com/a/22948350/9824424
//    @Override
//    public void onSensorChanged(SensorEvent sensorEvent) {
//
//        if (listener != null) {
//                    listener.onNewAzimuth(0);
//                }
//    }
    @Override
...
//                azimuth -= bearing(recentLocation.getLatitude(), recentLocation.getLongitude(), destination.getLatitude(), destination.getLongitude());
